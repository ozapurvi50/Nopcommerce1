Feature: Book Category
  ...
  Scenario Outline:  I should be able to see top menu tabs on homepage with categories
    ...
    Then      I should be able to see top menu tanbs with "<categoreis>"
  ...
  Scenario Outline:  I should be able to see book page with filters
    ...
    And      I should be ale to see "<filters>"
    Examples:
      | filters  |
      | Sortby   |
      | Display  |
  ...
  |Sortby |Price : Low to High|sorted product with the price in ascending order                 |
  |Sortby |Price : High to Low|sorted product with the price in descending order                |
